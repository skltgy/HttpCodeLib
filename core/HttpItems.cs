...
namespace HttpCodeLib
{
    ...
    public class HttpItems
    {
        ...
        /// Mozilla/5.0 (Linux; Android 5.1.1; Nexus 6 Build/LYZ28E) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/61.0.3159.5 Mobile Safari/537.36
        /// Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/39.0.2171.95 Safari/537.36 MicroMessenger/6.5.2.501 NetTypeWIFIWindowsWechatQBCore/3.43.656.400 QQBrowser/9.0.2524.400
        /// </summary>
        public string UserAgent
        {
            get
            {
                switch (UserAgentTypeEx)
                {
                    case UserAgentType.PC:
                        _UserAgent = "Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/55.0.2883.9 Safari/537.36";
                        break;
                    case UserAgentType.Phone:
                        _UserAgent = "Mozilla/5.0 (Linux; Android 5.1.1; Nexus 6 Build/LYZ28E) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/61.0.3159.5 Mobile Safari/537.36";
                        break;
                    case UserAgentType.WeChat:
                        _UserAgent = "Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/39.0.2171.95 Safari/537.36 MicroMessenger/6.5.2.501 NetType/WIFI WindowsWechat QBCore/3.43.656.400 QQBrowser/9.0.2524.400";
                        break;
                    default:
                        break;
                }
        ...
        private UserAgentType _UserAgentTypeEx = UserAgentType.PC;
        /// <summary>
        /// 用户类型属性.默认为PC
        /// PC/手机(安卓5.1.1)/WeChat
        /// </summary>
        public UserAgentType UserAgentTypeEx
        {
            get { return _UserAgentTypeEx; }
            set { _UserAgentTypeEx = value; }
        }
        ...
        private int connectionlimit = 65530;
        /// <summary>
        /// 最大连接数
        /// </summary>
        ...
        public WebHeaderCollection Header
        {
            get
            {
                ...
                {
                    var chs = HeaderStr.Split(new string[] { "\r\n", "\n" }, StringSplitOptions.RemoveEmptyEntries);
